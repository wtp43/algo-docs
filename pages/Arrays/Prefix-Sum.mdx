---
modified: 2024-12-30T18:56:43-05:00
---
...
<CustomCallout type="tip" title="tip">Can be used to find max/min of some f(subarray) for all subarrays in O(n) </CustomCallout>
