---
modified: 2024-12-30T18:51:21-05:00
---
# Sliding Window
- Sum of window and prefix sums are useful
- What is the state of the window we need to keep track of?

<CustomCallout type="note" title="note">Sliding window only works for positive numbers as it assumes increasing the window size will also increase the current counter.</CustomCallout>
