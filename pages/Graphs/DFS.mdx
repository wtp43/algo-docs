---
modified: 2024-12-30T22:20:01-05:00
---
# Depth First Search
...
[Connected-Components](/Advanced-Data-Structures/Connected-Components.mdx)
...
<CustomCallout type={"note"} title={"note"}>Recursively fix the $i^{th}$ element. Available choices are `a[i...n]`. Swap the chosen element with the $i^{th}$ element and continue until the last position.</CustomCallout>
