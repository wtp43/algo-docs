---
modified: 2024-12-30T22:19:39-05:00
---
## Bellman Ford

<CustomCallout type={"note"} title={"note"}>Bellman Ford iteratively relaxes the distance from u to v**Complexity**: O(VE) Intuitively, |V-1| iterations are needed because that's the largest amount of stops the longest possible shortest path from source s to destination v can have.</CustomCallout>
...
[Graph-Theory](/Graphs/Graph-Theory.mdx)
