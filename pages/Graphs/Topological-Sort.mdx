...
created: 2022-12-10
modified: 2024-12-30T22:23:20-05:00
---
# Topological Sort
...
<CustomCallout type={"example"} title={"example"}>![Pasted-image-20230106154005.png](https://algorithms-doc.vercel.app/assets/images/Pasted-image-20230106154005-f2b963c628667e25416af2a6a712837b.png)![Pasted-image-20230106154013.png](https://algorithms-doc.vercel.app/assets/images/Pasted-image-20230106154013-5870dd7b5a83c14af1964ead2468999b.png)</CustomCallout>

<CustomCallout type={"Purpose"} title={"Purpose"}>Gives an ordering where each vertex can be processed before it's successors. This allows us to seek the shortest/longest path from x to y in a DAG</CustomCallout>
...
[Floyd-s-Cycle-Detection-Algorith](/Graphs/Floyd-s-Cycle-Detection-Algorithm.mdx)
