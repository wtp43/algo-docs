...
title: 0 1 Knapsack
created: 2023-02-01
modified: 2024-12-31T03:20:10-05:00
---
# Description
...
<CustomCallout type={"danger"} title={"danger"}></CustomCallout>
...
- So items going into the knapsack are B and D.

<CustomCallout type={"important"} title={"important"}>If we included the current item i, then our weight cannot be equal to `dp[i-1][capacity]`.Otherwise, we excluded the current item and its weight is equal to `dp[i-1][capacity]`.</CustomCallout>
