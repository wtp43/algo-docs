---
modified: 2024-12-30T22:27:47-05:00
---
# KMP
## Pattern Matching
...
<CustomCallout type="important" title="important">F is an array of maximal boundaries for every substring `s[0:i] for i in range(len(s))`</CustomCallout>
