...
title: LRU Cache
created: 2022-12-16
modified: 2024-12-30T22:52:05-05:00
---
# LRU Cache
...
<CustomCallout type={"Time-Complexity"} title={"Time Complexity"}>Lookup: O(1)</CustomCallout>

<CustomCallout type={"Space-Complexity"} title={"Space Complexity"}>O(n)</CustomCallout>

# Related

[LFU-Cache](/Advanced-Data-Structures/LFU-Cache.mdx)
