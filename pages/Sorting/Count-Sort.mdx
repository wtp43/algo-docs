...
title: Count Sort
created: 2022-12-15
modified: 2024-12-30T22:25:05-05:00
---
# Count Sort
...
![Pasted-image-20221215155937.png](https://algorithms-doc.vercel.app/assets/images/Pasted-image-20221215155937-13792c9f8a611b7b61bf6f7150ab575d.png)

<CustomCallout type="note" title="note">Count sort is only really viable, time complexity less than O($n\log n$) if the length of the frequency map used is bounded by O($n$)</CustomCallout>
